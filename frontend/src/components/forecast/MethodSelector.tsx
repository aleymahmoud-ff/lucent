...
const methods = [
  {
    id: "arima" as const,
    name: "ARIMA",
    description: "Best for data with trends and autocorrelation patterns",
    icon: TrendingUp,
  ...
  },
  {
    id: "ets" as const,
    name: "ETS",
    description: "Exponential smoothing for clear patterns and seasonality",
    icon: Waves,
  ...
  },
  {
    id: "prophet" as const,
    name: "Prophet",
    description: "Facebook's model for business time series with holidays",
    icon: Calendar,
